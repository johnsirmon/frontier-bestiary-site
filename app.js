(() => {
  ...
  app.innerHTML = `
    ...
    <footer>Scores, evidence classifications, throughput, metadata, and token prices reproduce the captured <a href="${esc(current.source)}" target="_blank" rel="noreferrer">BenchLM homepage snapshot ↗</a>; linked model-detail records can update on a different cadence. The shared dragon species and breed identities are illustrative.</footer>`;
